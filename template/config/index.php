                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">OP Over view</h4>
                          ...
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">CASES OVER VIEW</h4>
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td><div class="badge badge-opacity-success">OPEN</div></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </div>
